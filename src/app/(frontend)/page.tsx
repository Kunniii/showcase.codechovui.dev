    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-8">
      <header className="pt-20 pb-16 sm:pt-32 sm:pb-24 text-left max-w-4xl mx-auto flex flex-col items-center">
        <h1 className="text-base sm:text-[1.25rem] leading-[1.8] sm:leading-[1.9] text-primary font-desc font-normal tracking-wide">
          ...
          <span>
            Mình siêu thích nghe nhạc, lang thang chụp ảnh random, gõ code vjp pro, overthinking, viết lách bậy bạ và nghịch đất trồng cây. Chỗ này là cái <span className="relative group/secret cursor-help font-medium text-primary border-b-2 border-primary/30 border-dashed">
              "kho bí mật"
            ...
            </span> để mình cất giấu mấy trò nghịch ngợm linh tinh với hình ảnh đó! 
            Nếu bạn tò mò <a href="/about" className="text-primary hover:text-secondary transition-colors border-b border-primary/20 hover:border-transparent pb-0.5 whitespace-nowrap">câu chuyện của mình</a>, 
            hay rủ rê chém gió qua 
            <span className="inline-flex items-center gap-2 mx-2 align-middle translate-y-[-1px]">
              <a href="https://github.com/Kunniii" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-secondary transition-transform hover:scale-110" aria-label="GitHub">
                <svg className="w-5 h-5 sm:w-[1.2rem] sm:h-[1.2rem]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
              </a>
              <a href="https://www.instagram.com/n.phi.truong" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-secondary transition-transform hover:scale-110" aria-label="Instagram">
                <svg className="w-5 h-5 sm:w-[1.2rem] sm:h-[1.2rem]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
              <a href="https://www.facebook.com/Nguyen.PhiTruong.5801" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-secondary transition-transform hover:scale-110" aria-label="Facebook">
                <svg className="w-5 h-5 sm:w-[1.2rem] sm:h-[1.2rem]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
              </a>
            </span>
