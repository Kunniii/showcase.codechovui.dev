...
export default function ImageLightbox({ src, alt, width, height, priority = false, exif }: ImageLightboxProps) {
      ...
      {isOpen && mounted && createPortal(
        ...
        >
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-[110] bg-surface/80 backdrop-blur border border-border-subtle text-secondary px-4 py-2 rounded-full text-xs font-medium hidden sm:flex items-center gap-4 shadow-sm pointer-events-none">
            <span className="flex items-center gap-1"><kbd className="font-sans border border-border-strong rounded px-1 text-[10px]">ESC</kbd> Đóng</span>
            <span className="flex items-center gap-1"><kbd className="font-sans border border-border-strong rounded px-1 text-[10px]">SCROLL</kbd> Thu phóng</span>
            <span className="flex items-center gap-1"><kbd className="font-sans border border-border-strong rounded px-1 text-[10px]">DRAG</kbd> Di chuyển</span>
          </div>
